...
from controllers.pass_rental_usage_controller import pass_rental_usage_controller
...
app.register_blueprint(pass_rental_usage_controller, url_prefix='/pass_rental_usages')
